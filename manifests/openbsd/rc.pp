...
#  If specified as a hash, then it must contain "name" and
#  "value" keys of the setting and its value and may also
#  contain an optional "comment" key that will place a comment

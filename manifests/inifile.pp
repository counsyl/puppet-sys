...
# === Parameters
#
# Technically only the required parameter is the name of the resource (the
# path to the configuration file).  But it will be empty without supplying
# anything in the configuration hash.
#
# [*config*]
#   Configuration hash.  Keys are sections, values are hashes of setting/value
#   pairs.  Sections and settings within sections are sorted in the output.
#
# [*alias*]
#   Alias to use for the file resource of the ini file; defaults to undef.
#
# [*header*]
